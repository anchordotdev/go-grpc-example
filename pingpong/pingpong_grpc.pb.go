...
type PingPongClient interface {
	ServePingPong(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error)
}
...
func (c *pingPongClient) ServePingPong(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/pingpong.PingPong/ServePingPong", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PingPongServer interface {
	ServePingPong(context.Context, *Message) (*Message, error)
...
func (UnimplementedPingPongServer) ServePingPong(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ServePingPong not implemented")
}
...
func _PingPong_ServePingPong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PingPongServer).ServePingPong(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pingpong.PingPong/ServePingPong",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PingPongServer).ServePingPong(ctx, req.(*Message))
	}
...
var PingPong_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ServePingPong",
			Handler:    _PingPong_ServePingPong_Handler,
		},
	},
